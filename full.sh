...
PYTHON_SCRIPT="update_manager.py"

# Define the path to the combined script
COMBINED_SCRIPT="RobertOS_Update_Manager.sh"

# Combine the Bash and Python scripts into one executable Bash script
...
# Append the Python script to the combined Bash script
cat "$PYTHON_SCRIPT" >> "$COMBINED_SCRIPT"

# Set executable permission for the combined script
chmod +x "$COMBINED_SCRIPT"

# Inform the user
echo "Combined script created successfully at $COMBINED_SCRIPT"
